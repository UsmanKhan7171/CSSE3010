...
TaskHandle_t s4396122_TaskPanTiltHandle;    //!< PanTilt Task Handle

//! If the PanTilt is in metronomeMode
int metronomeMode = 0;
int panVal = 0;                             //!< Current Pan Value
int tiltVal = 0;                            //!< Current Tilt Value
