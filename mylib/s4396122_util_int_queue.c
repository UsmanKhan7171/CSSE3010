...
/**
 * @brief Appends a string to the end of the IntQueue
 *
 * @param q         IntQueue to add string to
 * @param message   String to add to the end of the IntQueue
 */
...
/**
 * @brief Converts Queue to string
 *
 * @param q         Queue to get elements from
 * @param buffer    String to write to. Buffer must be big enough to support 
 * the whole string
 */
...
/**
 * @brief Converts an IntQueue of char ints to int
 *
 * @param q IntQueue to read from
 *
