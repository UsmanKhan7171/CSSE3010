...
/**
 * @brief Creates a number between 0 and MAP_SIZE for hashing key values
...
/**
 * @brief Creates and empty map for adding data
...
/**
 * @brief Adds an element to the map, if the key exists in memory than the old 
 * pair will be removed from memory
...
/**
 * @brief Gets the data referenced with the key
